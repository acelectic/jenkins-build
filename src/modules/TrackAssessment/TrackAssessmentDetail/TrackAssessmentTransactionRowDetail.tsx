...
type TrackAssessmentTransactionRowDetailProps = {
  index: number
  viewMode?: boolean
  length?: number
  editMode?: boolean
...
const TrackAssessmentTransactionRowDetail = (
  props: TrackAssessmentTransactionRowDetailProps
) => {
  const { index, length = -1, titleName, description, actaul } = props
        ...
        <ViewModeFieldContainer>
          ...
          >
            ...
            <div style={{ marginRight: "100px" }}>
              {!viewMode && <Icon iconName="notePencil" />}
            </div>
          </div>
        </ViewModeFieldContainer>
      </FieldContainer>
...
export default TrackAssessmentTransactionRowDetail
